...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.cap="Ratio of average fitness difference as a function of niche overlap and stabilizing niche differences",fig.pos = 'p'}
x <- seq(0,1,0.01)
y1 <- 1/x
y2 <- x*0
