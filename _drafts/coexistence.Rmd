...
```{r, echo=FALSE}
knitr::opts_chunk$set(fig.path='{{ site.url }}/images/coexistence-')
```
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.cap="Ratio of average fitness difference as a function of niche overlap and stabilizing niche differences",fig.align='center'}
x <- seq(0,1,0.01)
y1 <- 1/x
y2 <- x*0
