...
```{r, echo=FALSE}
knitr::opts_chunk$set(fig.path='../images/coexistence-')
```
...
```{r,message=FALSE,warning=FALSE,fig.width=6,fig.height=3,fig.cap='Ratio of average fitness difference as a function of niche overlap and stabilizing niche differences'}
x <- seq(0,1,0.01)
y1 <- 1/x
y2 <- x*0
