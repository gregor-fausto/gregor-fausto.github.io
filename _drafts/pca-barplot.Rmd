...
```{r, echo=FALSE}
knitr::opts_chunk$set(fig.path='{{ site.url }}/images/pca-barplot-',fig.align='center')
```
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.cap="Basic PCA barplot"}
library(ggplot2)
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.cap="PCA barplot with groups identified by color"}
ggplot(df) +
